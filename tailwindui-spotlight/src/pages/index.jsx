...
import orcAndSwordImage from '@/images/photos/sword-orc-cropped.jpg'
import internshipGroupPhoto from '@/images/photos/IMG_7625.jpg'
import kayakPhoto from '@/images/photos/IMG_5114.jpg';
import GbsRetreatMixerPhoto from '@/images/photos/1627242756615.jpg';
import logoBlizzard from '@/images/logos/blizzard_logo_round.png'
import logoGamebreaking from '@/images/logos/gbs_logo_round.png'
...
function Resume() {
  let resume = [
    {
      company: 'Gamebreaking Studios',
      title: 'Senior Software Engineer',
      logo: logoGamebreaking,
      start: '2021',
      end: 'current',
    },
    {
...
function Photos() {
  ...
  const images = [
    GbsRetreatMixerPhoto,
    kayakPhoto,
    orcAndSwordImage,
    internshipGroupPhoto,
  ];
  return (
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://twitter.com/kviglucci"
              aria-label="Follow on Twitter"
              icon={TwitterIcon}
            />
            <SocialLink
              href="https://github.com/viglucci"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/kevin-viglucci-a0010078/"
