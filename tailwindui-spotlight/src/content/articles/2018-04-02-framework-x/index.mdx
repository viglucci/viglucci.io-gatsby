...
![require('framework-x')](/images/articles/2018-04-02-framework-x/HDtNnOg.png)
...
Check out the below screenshot for an example of how I think the API might look down the road.

![](/images/articles/2018-04-02-framework-x/hLj4wFM.png)
